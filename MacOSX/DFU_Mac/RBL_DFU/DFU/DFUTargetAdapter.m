...
+ (CBUUID *) serviceUUID
{
    return [CBUUID UUIDWithString:@DFU_SERVICE_UUID];
}

+ (CBUUID *) controlPointCharacteristicUUID
{
    return [CBUUID UUIDWithString:@DFU_CONTROL_POINT_UUID];
}

+ (CBUUID *) packetCharacteristicUUID
{
    return [CBUUID UUIDWithString:@DFU_DATA_PACKET_UUID];
}
...
- (void) peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error
{
    ...
    NSLog(@"Received notify %@. Value: %@.", characteristic, characteristic.value);
